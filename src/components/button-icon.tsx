...
export const buttonIconVariantsIcon = cva("transition", {
    variants: {
        variant: {
            none: "",
            primary: "fill-white",
...
export default function ButtonIcon({
    variant, size, disabled, className, icon, loading, ...props
    ...
    return <button className={buttonIconVariants({ variant, size, disabled, className })} {...props}>
        <Icon className={buttonIconVariantsIcon({ variant, size })} svg={icon} />
    </button>
}